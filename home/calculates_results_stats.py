...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        ...
        if results_dic[key][3] == 1 and results_dic[key][2] == 1 and results_dic[key][4] == 1:
